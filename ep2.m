...
MI(:, col_eq(0):col_eq(4)-1) = miferro;
MI(:, col_eq(16)+1:col_eq(20)-1) = miferro;
MI(row_eq(0):row_eq(4)-1, col_eq(5)+1:col_eq(20)-1) = miferro;
MI(row_eq(16)+1:row_eq(20), col_eq(5)+1:col_eq(20)-1) = miferro;
